...
public class ProductOverviewClientConfig {
    ...
    private static final String OVERVIEW_SYSTEM = "Redacta una reseña breve en español, tono profesional y orientada a la decisión de compra. Explica qué es el producto y su nivel (básico, medio o alto), interpreta su utilidad en escenarios reales (trabajo, estudio, gaming, etc.), y resalta ventajas y posibles limitaciones. Menciona condición y precio si están disponibles. No repitas ni enumeres especificaciones técnicas ni copies datos literalmente; conviértelos en beneficios. Máximo 80-100 palabras.";
