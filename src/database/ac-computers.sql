...
('Gabinete Gamer Vidrio Templado lhc-31', 'Gabinete con diseño moderno y panel de vidrio templado para mostrar los componentes internos.', 450000, 0, '2024-01-25 08:45:00'),
...
('MOUSE COUGAR 700M', 'Mouse ergonómico y ajustable con precisión de 16,000 DPI, ideal para juegos.', 185000, 0, '2024-02-15 12:15:00'),
...
('COMBO VSG CRUX TECLADO + MOUSE + DIADEMA + PAD MOUSE', 'Set completo de periféricos gaming con iluminación LED.', 174000, 0, '2024-03-05 10:30:00'),
...
('FUENTE COOLER MASTER MWE 750W', 'Fuente de poder de 750W con certificación 80 PLUS Bronze, ideal para configuraciones de alto rendimiento.', 387000, 0, '2024-03-25 13:45:00'),
('Memoria Ram DDR5 RGB 2800MHZ', 'Módulo de RAM DDR5 con iluminación RGB y velocidad de 2800MHz, ideal para gaming y tareas intensivas.', 570000, 0, '2024-04-05 16:00:00'),
('Webcam Logitech C920 HD Pro', 'Webcam de alta definición con enfoque automático y micrófono estéreo integrado.', 250000, 0, '2024-04-25 11:45:00'),
...
('Duericulares inalámbricos SteelSeries Arctis 7', 'Auriculares inalámbricos con sonido envolvente 7.1 y micrófono retráctil.', 650000, 0, '2024-05-15 12:30:00'),
...
('Monitor Curvo Samsung Odyssey G7 27" QLED', 'Monitor curvo de 27 pulgadas con tecnología QLED y resolución WQHD.', 1800000, 0, '2024-06-15 14:30:00'),
('Tarjeta madre MSI B550 Tomahawk', 'Placa base con soporte para procesadores AMD Ryzen de tercera generación y PCIe 4.0.', 650000, 0, '2024-06-25 16:00:00'),
('Mousepad Gaming Corsair MM800 RGB Polaris', 'Mousepad con iluminación RGB personalizable y superficie de microtextura para precisión en los movimientos.', 180000, 0, '2024-07-05 09:45:00'),
('Sistema de altavoces Logitech Z623 2.1', 'Sistema de altavoces con subwoofer y sonido envolvente, certificado por THX.', 550000, 0, '2024-07-15 13:00:00'),
...
('Silla Gamer DXRacer Formula Series', 'Silla ergonómica para gaming con soporte lumbar y ajuste de altura.', 1200000, 0, '2024-01-12 17:30:00'),
...
('Amalia', 'Castro Ardila', 'amaliacastro@misena.edu.co', '$2b$10$yXfuo9Fn32dFOE6Td0F0vudIL2hQujSsivJvRnK4AxLyffQt4o236')