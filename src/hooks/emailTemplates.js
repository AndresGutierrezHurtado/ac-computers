export const feedbackTemplate = (email, subject, message) => {
    return `
        ...
        <html>
            ...
            <body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #111722; color: #f8fafc; padding-top: 2rem; padding-bottom: 2rem;">
                <div style="max-width: 500px; margin: 0 auto; background-color: #1e293b; padding: 20px; border: 1px solid #334155; text-align: center; border-radius: 8px;">
                    <h1 style="font-size: 24px; color: #f8fafc; margin-bottom: 20px; font-weight: 700;">
                        Formulario Contacto
                        <span style="font-size: 28px; color: #4e99d3; font-weight: 800;">AC Computers</span>
                    </h1>

                    <p style="font-size: 16px; margin: 10px 0; color: #f8fafc;">Email de contacto: <strong>${email}</strong></p>
                    <p style="font-size: 16px; margin: 10px 0; color: #f8fafc;">Asunto: <strong>${subject}</strong></p>
                    <p style="font-size: 16px; margin: 10px 0; color: #f8fafc;">Mensaje:</p>
                    <p style="font-size: 16px; margin: 10px 0; color: #f8fafc;">${message}</p>

                    <a href="mailto:${email}" style="display: inline-block; background-color: #4e99d3; color: #020617; padding: 12px 25px; text-decoration: none; border-radius: 4px; font-size: 16px; margin: 20px 0; font-weight: bold;">
                        Responder Correo
                    </a>

                    <h2 style="font-size: 20px; margin-top: 20px; color: #4e99d3;">¿Algún Error?</h2>
                    <p style="font-size: 14px; color: #f8fafc;">
                    ...
                    <p style="font-size: 12px; color: #f8fafc;">© Andrés Gutiérrez Hurtado</p>
                </div>
            </body>
        </html>
    `;
